...
export class MarketPlaceContract__itemsResult {
  value0: BigInt;
  value1: Address;
  value2: BigInt;
  value3: string;
...
export class MarketPlaceContract__tokensResult {
  value0: BigInt;
  value1: string;
  value2: Address;
  value3: BigInt;
...
export class MarketPlaceContract extends ethereum.SmartContract {
  ...
  items(param0: BigInt): MarketPlaceContract__itemsResult {
    let result = super.call(
      "items",
    ...
    return new MarketPlaceContract__itemsResult(
      result[0].toBigInt(),
      result[1].toAddress(),
      result[2].toBigInt(),
      result[3].toString(),
  ...
  try_items(
    param0: BigInt
  ): ethereum.CallResult<MarketPlaceContract__itemsResult> {
    let result = super.tryCall(
      "items",
      "items(uint256):(uint256,address,uint256,string,uint256,address,uint256,address,bool,address)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    return ethereum.CallResult.fromValue(
      new MarketPlaceContract__itemsResult(
        value[0].toBigInt(),
        value[1].toAddress(),
        value[2].toBigInt(),
        value[3].toString(),
  ...
  tokens(param0: BigInt): MarketPlaceContract__tokensResult {
    let result = super.call(
      "tokens",
    ...
    return new MarketPlaceContract__tokensResult(
      result[0].toBigInt(),
      result[1].toString(),
      result[2].toAddress(),
      result[3].toBigInt(),
  ...
  try_tokens(
    param0: BigInt
  ): ethereum.CallResult<MarketPlaceContract__tokensResult> {
    let result = super.tryCall(
      "tokens",
      "tokens(uint256):(uint256,string,address,uint256,address)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new MarketPlaceContract__tokensResult(
        value[0].toBigInt(),
        value[1].toString(),
        value[2].toAddress(),
        value[3].toBigInt(),
